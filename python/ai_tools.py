...
def tool_get_financial_anomalies(
    start_date: str | None = None,
    end_date: str | None = None,
):
    return get_financial_anomalies(
        start_date=start_date,
        end_date=end_date,
    )
...
TOOL_REGISTRY = {
    ...
    "get_financial_anomalies": tool_get_financial_anomalies,
...
TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "description": (
            "Detect deterministic, explainable anomaly signals among posted "
            "EXPENSE and BANK_FEE financial transactions. Detect unusually "
            "large expenses, exact duplicate-looking transactions, and "
            "repeated bank-fee signatures. Results are investigation signals "
            "and do not modify accounting data."
        ),
        "parameters": {
            "type": "object",
            "properties": {
